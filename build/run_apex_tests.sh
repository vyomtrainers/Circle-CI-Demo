...
#sfdx force:org:create -f "Salesforce Template Application/config/project-scratch-def.json" -a ${CIRCLE_BRANCH} -s

#sfdx force:source:push -u ${CIRCLE_BRANCH}

#echo "Coverting source to metadata format"
#sfdx force:source:convert -d test_code -r "Salesforce Template Application/force-app"
...
sfdx force:source:deploy --sourcepath "Salesforce Template Application/force-app" --targetusername DevHub
